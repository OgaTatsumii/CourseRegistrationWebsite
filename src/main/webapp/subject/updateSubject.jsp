			...
			<div class="main">
				...
				<div class="main-content">
					<div class="form-container">
						<form id="formAddMonHoc" action="updateSubject" method="POST">
							<div class="form-content">
								<h2>Thông tin môn học</h2>
								<div class="form-group">
									<div class="idStudentContent">
										<label for="MaMonHoc">Mã Môn Học :</label> <input
											style="width: 90%" type="text" id="MaMonHoc" name="MaMonHoc"
											value="<%=(MonHoc != null) ? MonHoc.getMaMonHoc() : maMonHoc%>"
											required />
										<p class="error">
											<%=errorMessageMaMonHoc%>
										</p>
								...
								<div class="form-group">
									<div class="phoneContent">
										<label for="SDT">Tên môn học :</label> <input
											style="width: 125%" type="text" id="TenMonHoc"
											name="TenMonHoc"
											value="<%=(MonHoc != null) ? MonHoc.getTenMonHoc() : tenMonHoc%>"
											required />
										<p class="error">
											<%=errorMessageTenMonHoc%>
										</p>
								...
								<div class="form-group">
									<div class="idContent">
										<label for="SoTinChi">Số tín chỉ :</label> <input
											style="width: 110%" type="number" id="SoTinChi"
											name="SoTinChi"
											value="<%=(MonHoc != null) ? MonHoc.getSoTinChi() : soTinChi%>"
							...
							<button class="addSubject" type="submit">Sửa Môn Học</button>
						</form>
					</div>
				</div>
			</div>
